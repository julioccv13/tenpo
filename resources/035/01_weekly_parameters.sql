...
DROP TABLE IF EXISTS `${project_target}.temp.CHURN_{{period}}_{{ds_nodash}}_0001_Params`;
CREATE TABLE `${project_target}.temp.CHURN_{{period}}_{{ds_nodash}}_0001_Params` AS (  
