...
DROP TABLE IF EXISTS `${project_target}.temp.CHRN_BS_{{period}}_{{ds_nodash}}_0001_Params`;
CREATE TABLE `${project_target}.temp.CHRN_BS_{{period}}_{{ds_nodash}}_0001_Params` AS (
