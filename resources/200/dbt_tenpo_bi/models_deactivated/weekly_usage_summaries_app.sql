...
SELECT
 ...
 ,APPROX_QUANTILES( avg_deltat_mc_origen, 100)[offset(50)] median_avg_deltat_mc_origen
 ,APPROX_QUANTILES( avg_deltat_act_general_origen, 100)[offset(50)] median_avg_deltat_act_general_origen
 ,APPROX_QUANTILES( avg_deltat_tu_origen, 100)[offset(50)] median_avg_deltat_tu_origen
 ,APPROX_QUANTILES( avg_deltat_up_origen, 100)[offset(50)] median_avg_deltat_up_origen
 ,APPROX_QUANTILES( avg_deltat_cashin_general_origen, 100)[offset(50)] median_avg_deltat_cashin_general_origen
 ,APPROX_QUANTILES( avg_deltat_cashout_general_origen, 100)[offset(50)] median_avg_deltat_cashout_general_origen
 ,APPROX_QUANTILES( avg_deltat_cashin_bolsillo_general_origen , 100)[offset(50)] median_avg_deltat_cashin_bolsillo_general_origen
 ,APPROX_QUANTILES( avg_deltat_cashout_bolsillo_general_origen, 100)[offset(50)] median_avg_deltat_cashout_bolsillo_general_origen
 ,APPROX_QUANTILES( avg_deltat_p2p_origen, 100)[offset(50)] median_avg_deltat_p2p_origen
 ,APPROX_QUANTILES( avg_deltat_pp_retiro_app_origen , 100)[offset(50)] median_avg_deltat_pp_retiro_app_origen
FROM  {{source('tablones_analisis','tablon_weekly_vectores_usuarios')}}
WHERE 
    activo_mes_app is true
GROUP BY 
    1
ORDER BY 
    1 ASC