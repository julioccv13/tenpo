...
SELECT
  *,
  ROUND(SAFE_DIVIDE(mes_0,clientes), 4) mes0_clientes,
  ROUND(SAFE_DIVIDE(mes_1,clientes), 4) mes1_clientes,
  ROUND(SAFE_DIVIDE(mes_2,clientes), 4) mes2_clientes,
  ROUND(SAFE_DIVIDE(mes_3,clientes), 4) mes3_clientes,
  ROUND(SAFE_DIVIDE(mes_4,clientes), 4) mes4_clientes,
  ROUND(SAFE_DIVIDE(mes_5,clientes), 4) mes5_clientes,
  ROUND(SAFE_DIVIDE(mes_6,clientes), 4) mes6_clientes,
  ROUND(SAFE_DIVIDE(mes_7,clientes), 4) mes7_clientes,
  ROUND(SAFE_DIVIDE(mes_8,clientes), 4) mes8_clientes,
  ROUND(SAFE_DIVIDE(mes_9,clientes), 4) mes9_clientes,
  ROUND(SAFE_DIVIDE(mes_10,clientes), 4) mes10_clientes,
  ROUND(SAFE_DIVIDE(mes_11,clientes), 4) mes11_clientes,
  ROUND(SAFE_DIVIDE(mes_12,clientes), 4) mes12_clientes,
  ROUND(SAFE_DIVIDE(mes_13,clientes), 4) mes13_clientes,
  ROUND(SAFE_DIVIDE(mes_14,clientes), 4) mes14_clientes,
  ROUND(SAFE_DIVIDE(mes_15,clientes), 4) mes15_clientes,
  ROUND(SAFE_DIVIDE(mes_16,clientes), 4) mes16_clientes,
  ROUND(SAFE_DIVIDE(mes_17,clientes), 4) mes17_clientes,
  ROUND(SAFE_DIVIDE(mes_18,clientes), 4) mes18_clientes,
  ROUND(SAFE_DIVIDE(mes_19,clientes), 4) mes19_clientes,
  ROUND(SAFE_DIVIDE(mes_20,clientes), 4) mes20_clientes,
  ROUND(SAFE_DIVIDE(mes_0,total_ob), 4) mes0_ob,
  ROUND(SAFE_DIVIDE(mes_1,total_ob), 4) mes1_ob,
  ROUND(SAFE_DIVIDE(mes_2,total_ob), 4) mes2_ob,
  ROUND(SAFE_DIVIDE(mes_3,total_ob), 4) mes3_ob,
  ROUND(SAFE_DIVIDE(mes_4,total_ob), 4) mes4_ob,
  ROUND(SAFE_DIVIDE(mes_5,total_ob), 4) mes5_ob,
  ROUND(SAFE_DIVIDE(mes_6,total_ob), 4) mes6_ob,
  ROUND(SAFE_DIVIDE(mes_7,total_ob), 4) mes7_ob,
  ROUND(SAFE_DIVIDE(mes_8,total_ob), 4) mes8_ob,
  ROUND(SAFE_DIVIDE(mes_9,total_ob), 4) mes9_ob,
  ROUND(SAFE_DIVIDE(mes_10,total_ob), 4) mes10_ob,
  ROUND(SAFE_DIVIDE(mes_11,total_ob), 4) mes11_ob,
  ROUND(SAFE_DIVIDE(mes_12,total_ob), 4) mes12_ob,
  ROUND(SAFE_DIVIDE(mes_13,total_ob), 4) mes13_ob,
  ROUND(SAFE_DIVIDE(mes_14,total_ob), 4) mes14_ob,
  ROUND(SAFE_DIVIDE(mes_15,total_ob), 4) mes15_ob,
  ROUND(SAFE_DIVIDE(mes_16,total_ob), 4) mes16_ob,
  ROUND(SAFE_DIVIDE(mes_17,total_ob), 4) mes17_ob,
  ROUND(SAFE_DIVIDE(mes_18,total_ob), 4) mes18_ob,
  ROUND(SAFE_DIVIDE(mes_19,total_ob), 4) mes19_ob,
  ROUND(SAFE_DIVIDE(mes_20,total_ob), 4) mes20_ob,
FROM all_data
