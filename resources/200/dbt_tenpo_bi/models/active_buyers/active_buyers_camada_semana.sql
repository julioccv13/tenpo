...
SELECT
  *,
  ROUND(SAFE_DIVIDE(semana_0,clientes), 4) semana0_clientes,
  ROUND(SAFE_DIVIDE(semana_1,clientes), 4) semana1_clientes,
  ROUND(SAFE_DIVIDE(semana_2,clientes), 4) semana2_clientes,
  ROUND(SAFE_DIVIDE(semana_3,clientes), 4) semana3_clientes,
  ROUND(SAFE_DIVIDE(semana_4,clientes), 4) semana4_clientes,
  ROUND(SAFE_DIVIDE(semana_5,clientes), 4) semana5_clientes,
  ROUND(SAFE_DIVIDE(semana_6,clientes), 4) semana6_clientes,
  ROUND(SAFE_DIVIDE(semana_7,clientes), 4) semana7_clientes,
  ROUND(SAFE_DIVIDE(semana_8,clientes), 4) semana8_clientes,
  ROUND(SAFE_DIVIDE(semana_9,clientes), 4) semana9_clientes,
  ROUND(SAFE_DIVIDE(semana_10,clientes), 4) semana10_clientes,
  ROUND(SAFE_DIVIDE(semana_11,clientes), 4) semana11_clientes,
  ROUND(SAFE_DIVIDE(semana_12,clientes), 4) semana12_clientes,
  ROUND(SAFE_DIVIDE(semana_13,clientes), 4) semana13_clientes,
  ROUND(SAFE_DIVIDE(semana_14,clientes), 4) semana14_clientes,
  ROUND(SAFE_DIVIDE(semana_15,clientes), 4) semana15_clientes,
  ROUND(SAFE_DIVIDE(semana_16,clientes), 4) semana16_clientes,
  ROUND(SAFE_DIVIDE(semana_17,clientes), 4) semana17_clientes,
  ROUND(SAFE_DIVIDE(semana_18,clientes), 4) semana18_clientes,
  ROUND(SAFE_DIVIDE(semana_19,clientes), 4) semana19_clientes,
  ROUND(SAFE_DIVIDE(semana_20,clientes), 4) semana20_clientes,
  ROUND(SAFE_DIVIDE(semana_0,total_ob), 4) semana0_ob,
  ROUND(SAFE_DIVIDE(semana_1,total_ob), 4) semana1_ob,
  ROUND(SAFE_DIVIDE(semana_2,total_ob), 4) semana2_ob,
  ROUND(SAFE_DIVIDE(semana_3,total_ob), 4) semana3_ob,
  ROUND(SAFE_DIVIDE(semana_4,total_ob), 4) semana4_ob,
  ROUND(SAFE_DIVIDE(semana_5,total_ob), 4) semana5_ob,
  ROUND(SAFE_DIVIDE(semana_6,total_ob), 4) semana6_ob,
  ROUND(SAFE_DIVIDE(semana_7,total_ob), 4) semana7_ob,
  ROUND(SAFE_DIVIDE(semana_8,total_ob), 4) semana8_ob,
  ROUND(SAFE_DIVIDE(semana_9,total_ob), 4) semana9_ob,
  ROUND(SAFE_DIVIDE(semana_10,total_ob), 4) semana10_ob,
  ROUND(SAFE_DIVIDE(semana_11,total_ob), 4) semana11_ob,
  ROUND(SAFE_DIVIDE(semana_12,total_ob), 4) semana12_ob,
  ROUND(SAFE_DIVIDE(semana_13,total_ob), 4) semana13_ob,
  ROUND(SAFE_DIVIDE(semana_14,total_ob), 4) semana14_ob,
  ROUND(SAFE_DIVIDE(semana_15,total_ob), 4) semana15_ob,
  ROUND(SAFE_DIVIDE(semana_16,total_ob), 4) semana16_ob,
  ROUND(SAFE_DIVIDE(semana_17,total_ob), 4) semana17_ob,
  ROUND(SAFE_DIVIDE(semana_18,total_ob), 4) semana18_ob,
  ROUND(SAFE_DIVIDE(semana_19,total_ob), 4) semana19_ob,
  ROUND(SAFE_DIVIDE(semana_20,total_ob), 4) semana20_ob,
FROM all_data
