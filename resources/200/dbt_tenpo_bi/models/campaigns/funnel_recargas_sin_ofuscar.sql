...
SELECT DISTINCT
  IF(trx.id_usuario  > 0, CAST (trx.id_usuario AS STRING), (IF(trx.id_usuario < 0 AND trx.correo_usuario <> "",trx.correo_usuario,rec.suscriptor))) as id_usr,
  rec.suscriptor as id_sus,
  trx.correo_usuario as correo_usuario, 
  CASE 
