DROP TABLE IF EXISTS `tenpo-bi.tmp.permanencia_p2p_{{ds_nodash}}`;
CREATE TABLE `tenpo-bi.tmp.permanencia_p2p_{{ds_nodash}}` AS 
(
...
select distinct user as identity, cohort as permanencia_usuario_p2p
