...
DROP TABLE IF EXISTS `${project_target}.temp.P_{{ds_nodash}}_104_Params`;
CREATE TABLE `${project_target}.temp.P_{{ds_nodash}}_104_Params` AS (
    WITH airflow_params AS (
        ...
        SELECT
            ...
            ,DATETIME_SUB(DATETIME_TRUNC(Fecha_Ejec, MONTH), INTERVAL 1 YEAR) AS Fecha_Inicio_Analisis
