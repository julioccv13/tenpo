...
data = {
    "main_python_file_uri": f"gs://{environment}-source-files/034/main.py",
    "python_file_uris": f"gs://{environment}-source-files/core.zip",
    "args": {
        "class_name": "Process034",
        "ds_nodash":
        ...
        "project_source_1": "tenpo-private", 
        "project_source_2": "tenpo-bi-prod", 
        "project_source_3": "tenpo-datalake-prod", 
        "project_target": "tenpo-datalake-prod", 
    }
}
...
with airflow.DAG(
        '034_cloudrun_dag_scrapper_empresas',
        catchup=False,
