...
with airflow.DAG(
    "0001_hook-optim-m1-paypal-conhook",
    catchup=False,
    ...
    monitoring = BashOperator(
        task_id="monitoring",
        bash_command = base_command.format("hook-optim-m1-paypal-conhook",
                                           "hook-optim-m1-paypal-conhook-monitoring",
                                            project_target,
                                            "e2-standard-8",
                                            "1",
                                            environment,
    ...
    train_data_ingestion = BashOperator(
        ...
        bash_command = base_command.format("hook-optim-m1-paypal-conhook",
                                           "hook-optim-m1-paypal-conhook-train-data-ingestion",
                                            project_target,
                                            "e2-standard-8",
                                            "1",
                                            environment,
    ...
    train_data_validation = BashOperator(
        ...
        bash_command = base_command.format("hook-optim-m1-paypal-conhook",
                                           "hook-optim-m1-paypal-conhook-train-data-validation",
                                           project_target,
                                           "e2-standard-8",
                                           "1",
                                           environment,
    ...
    train_data_preprocessing = BashOperator(
        ...
        bash_command = base_command.format("hook-optim-m1-paypal-conhook",
                                           "hook-optim-m1-paypal-conhook-train-data-preprocessing",
                                           project_target,
                                           "e2-standard-8",
                                           "1",
                                           environment,
    ...
    train_train = BashOperator(
        task_id="train_train",
        bash_command = base_command.format("hook-optim-m1-paypal-conhook",
                                           "hook-optim-m1-paypal-conhook-train-train",
                                           project_target,
                                           "e2-standard-8",
                                           "1",
                                           environment,
    ...
    train_model_validate = BashOperator(
        ...
        bash_command = base_command.format("hook-optim-m1-paypal-conhook",
                                           "hook-optim-m1-paypal-conhook-train-model-validate",
                                           project_target,
                                           "e2-standard-8",
                                           "1",
                                           environment,
    ...
    inference_data_ingestion = BashOperator(
        ...
        bash_command = base_command.format("hook-optim-m1-paypal-conhook",
                                           "hook-optim-m1-paypal-conhook-inference-data-ingestion",
                                           project_target,
                                           "e2-standard-8",
                                           "1",
                                           environment,
    ...
    inference_data_validation = BashOperator(
        ...
        bash_command = base_command.format("hook-optim-m1-paypal-conhook",
                                           "hook-optim-m1-paypal-conhook-inference-data-validation",
                                           project_target,
                                           "e2-standard-8",
                                           "1",
                                           environment,
    ...
    inference_data_preprocessing = BashOperator(
        ...
        bash_command = base_command.format("hook-optim-m1-paypal-conhook",
                                           "hook-optim-m1-paypal-conhook-inference-data-preprocessing",
                                           project_target,
                                           "e2-standard-8",
                                           "1",
                                           environment,
    ...
    inference_inference = BashOperator(
        ...
        bash_command = base_command.format("hook-optim-m1-paypal-conhook",
                                           "hook-optim-m1-paypal-conhook-inference-inference",
                                           project_target,
                                           "e2-standard-8",
                                           "1",
                                           environment,
