...
body = '{"campaign_id":"28656b28-ab64-43e8-9af2-61b8494b2922","segment_sql_file_path":"gs://prod_campaign_streaming_files/segments_sql_files/pdc/20230830_luz_globa.sql"}'
...
default_args = {
    ...
    "start_date": pendulum.datetime(2023, 8, 30, tz="UTC"),
...
dag = DAG(
    "053_pdc_luz_global_workflow",
    default_args=default_args,
    schedule_interval="0 */2 30,31,1 8-9 *",
    max_active_runs=1,
)
