...
data = {
    "main_python_file_uri": f"gs://{environment}-source-files/024/main.py",
    "python_file_uris": f"gs://{environment}-source-files/core.zip",
    "args": {
        "period": "daily",
        "class_name": "Process024",
        "ds_nodash":
        '{{ dag_run.conf["exec_date"] if "exec_date" in dag_run.conf else ds_nodash }}',
        "bucket_name": f"{environment}-source-files",
        "project_id": "tenpo-bi",
        "project_source_1": "tenpo-cl", 
        "project_source_2": "tenpo-airflow-prod", 
        "project_source_3": "tenpo-bi-prod", 
        "project_source_4": "tenpo-bi", 
        "project_target": "tenpo-piratas-mart-prod"
    }
}
