...
GENDERIZE_API_KEY = Variable.get("genderize_api_key")
SLACK_CONN_ID = f"slack_conn-{environment}"

data = {
    "main_python_file_uri": f"gs://{environment}-source-files/010/main.py",
    "python_file_uris": f"gs://{environment}-source-files/core.zip",
    "args": {
        "class_name": "Process010",
        "ds_nodash":
        ...
        "project_source_2": "tenpo-rf", 
        "project_source_3": "hallowed-port-272015", 
