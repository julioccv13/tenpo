...
SBIF_API_KEY = Variable.get("api_sbif_secret")
SLACK_CONN_ID = f"slack_conn-{environment}"

data = {
    "main_python_file_uri": f"gs://{environment}-source-files/001/main.py",
    ...
    "args": {
        ...
        "project_id": "tenpo-bi",
        "project_source": "tenpo-datalake-prod",
...
with airflow.DAG(
        '001_cloudrun_dag_Ingesta_Dolar_CMF',
        catchup=False,
