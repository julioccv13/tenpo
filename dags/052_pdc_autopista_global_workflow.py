...
body = '{"campaign_id":"13230cae-67fe-41ef-8b83-c80cdfc932ae","segment_sql_file_path":"gs://prod_campaign_streaming_files/segments_sql_files/pdc/20230824_autopista_global.sql"}'
...
default_args = {
    ...
    "start_date": pendulum.datetime(2023, 8, 25, tz="UTC"),
...
dag = DAG(
    "052_pdc_autopista_global_workflow",
    default_args=default_args,
    schedule_interval="0 */2 25-26 8 *",
    max_active_runs=1,
)
