...
body = '{"campaign_id":"87756121-0f98-4c5d-96b9-2c9ba91117b5","segment_sql_file_path":"gs://prod_campaign_streaming_files/segments_sql_files/pdc/20230807_autopista_global.sql"}'
...
dag = DAG(
    "049_pdc_autopista_global_workflow",
    default_args=default_args,
    schedule_interval="0 */2 7,8 8 *",
    max_active_runs=1,
)
