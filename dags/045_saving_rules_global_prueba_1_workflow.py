...
body = '{"campaign_id":"1c10b642-64d1-4612-82aa-8f548ee46b43","segment_sql_file_path":"gs://prod_campaign_streaming_files/segments_sql_files/pdc/20230704_regla_automatica_bolsillo.sql"}'
...
dag = DAG(
    "045_saving_rules_global_prueba_1_workflow",
    default_args=default_args,
    schedule_interval="0 */2 5,6,7 7 *",
    max_active_runs=1,
)
