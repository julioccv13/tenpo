...
body = '{"campaign_id":"6ed85853-370d-4a06-8862-3fd6fcd9619b","segment_sql_file_path":"gs://prod_campaign_streaming_files/segments_sql_files/pdc/20230808_regla_automatica_bolsillo_purchase_cashin.sql"}'
...
dag = DAG(
    "050_saving_rules_global_workflow",
    default_args=default_args,
    schedule_interval="0 */2 7-22 8 *",
    max_active_runs=1,
)
