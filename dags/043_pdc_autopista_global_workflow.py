...
body = '{"campaign_id":"9e2165a4-ed5c-4244-ae0c-62bfdc4e340f","segment_sql_file_path":"gs://prod_campaign_streaming_files/segments_sql_files/pdc/20230622_20porciento_autopista.sql"}'
...
default_args = {
    ...
    "start_date": pendulum.datetime(2023, 6, 22, tz="UTC"),
...
dag = DAG(
    "043_pdc_autopista_global_workflow",
    default_args=default_args,
    schedule_interval="0 */2 22 6 *",
    max_active_runs=1,
)
