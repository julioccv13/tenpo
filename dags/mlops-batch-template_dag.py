...
with airflow.DAG(
    ...
    monitoring = BashOperator(
        task_id="monitoring",
        bash_command = base_command.format("mlops-batch-template",
                                           "mlops-batch-template-monitoring",
                                            project_target,
                                            "n1-standard-4",
                                            "1",
                                            environment,
    ...
    train_data_ingestion = BashOperator(
        ...
        bash_command = base_command.format("mlops-batch-template",
                                           "mlops-batch-template-train-data-ingestion",
                                            project_target,
                                            "n1-standard-4",
                                            "1",
                                            environment,
    ...
    train_data_validation = BashOperator(
        ...
        bash_command = base_command.format("mlops-batch-template",
                                           "mlops-batch-template-train-data-validation",
                                           project_target,
                                           "n1-standard-4",
                                           "1",
                                           environment,
    ...
    train_data_preprocessing = BashOperator(
        ...
        bash_command = base_command.format("mlops-batch-template",
                                           "mlops-batch-template-train-data-preprocessing",
                                           project_target,
                                           "n1-standard-4",
                                           "1",
                                           environment,
    ...
    train_train = BashOperator(
        task_id="train_train",
        bash_command = base_command.format("mlops-batch-template",
                                           "mlops-batch-template-train-train",
                                           project_target,
                                           "n1-standard-4",
                                           "1",
                                           environment,
    ...
    train_model_validate = BashOperator(
        ...
        bash_command = base_command.format("mlops-batch-template",
                                           "mlops-batch-template-train-model-validate",
                                           project_target,
                                           "n1-standard-4",
                                           "1",
                                           environment,
    ...
    inference_data_ingestion = BashOperator(
        ...
        bash_command = base_command.format("mlops-batch-template",
                                           "mlops-batch-template-inference-data-ingestion",
                                           project_target,
                                           "n1-standard-4",
                                           "1",
                                           environment,
    ...
    inference_data_validation = BashOperator(
        ...
        bash_command = base_command.format("mlops-batch-template",
                                           "mlops-batch-template-inference-data-validation",
                                           project_target,
                                           "n1-standard-4",
                                           "1",
                                           environment,
    ...
    inference_data_preprocessing = BashOperator(
        ...
        bash_command = base_command.format("mlops-batch-template",
                                           "mlops-batch-template-inference-data-preprocessing",
                                           project_target,
                                           "n1-standard-4",
                                           "1",
                                           environment,
    ...
    inference_inference = BashOperator(
        ...
        bash_command = base_command.format("mlops-batch-template",
                                           "mlops-batch-template-inference-inference",
                                           project_target,
                                           "n1-standard-4",
                                           "1",
                                           environment,
