...
body = '{"campaign_id":"218aaa56-3196-4a3e-940d-12c716c012cf","segment_sql_file_path":"gs://prod_campaign_streaming_files/segments_sql_files/pdc/20230907_COF_prueba.sql"}'
...
dag = DAG(
    "055_COF_workflow_prueba",
    default_args=default_args,
    schedule_interval="0 */2 6,7,8,9,10 9 *",
    max_active_runs=1,
)
