...
body = '{"campaign_id":"709a95dd-02e0-464d-bc82-4feb822c420c","segment_sql_file_path":"gs://prod_campaign_streaming_files/segments_sql_files/pdc/20230906_pdc_automatico_prueba_retool.sql"}'
...
dag = DAG(
    "054_pdc_automatico_workflow_prueba_v2",
    default_args=default_args,
    schedule_interval="0 */2 6,7,8 9 *",
    max_active_runs=1,
)
