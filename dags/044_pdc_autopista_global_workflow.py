...
body = '{"campaign_id":"8a005bb2-f748-41b0-a06c-c8b5dbbad2d3","segment_sql_file_path":"gs://prod_campaign_streaming_files/segments_sql_files/pdc/20230629_20porciento_autopista.sql"}'
...
default_args = {
    ...
    "start_date": pendulum.datetime(2023, 6, 30, tz="UTC"),
...
dag = DAG(
    "044_pdc_autopista_global_workflow",
    default_args=default_args,
    schedule_interval="0 */2 30,1 6-7 *",
    max_active_runs=1,
)
