...
body = '{"campaign_id":"2b4d103f-8e69-422a-a458-49627e826b03","segment_sql_file_path":"gs://prod_campaign_streaming_files/segments_sql_files/pdc/20230728_autopista_global.sql"}'
...
dag = DAG(
    "047_pdc_autopista_global_workflow",
    default_args=default_args,
    schedule_interval="0 */2 28,29 7 *",
    max_active_runs=1,
)
