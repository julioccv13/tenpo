...
PARAMETERS_PATH = "gs://{bucket_name}/004/queries/01_Parameters.sql"
QUERY_PATH = "gs://{bucket_name}/004/queries/02_Query.sql"
INSERT_PATH = "gs://{bucket_name}/004/queries/03_Insert.sql"



class Process004(Process):
