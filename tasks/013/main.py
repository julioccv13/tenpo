...
PARAMETERS_PATH = "gs://{bucket_name}/013/queries/01_parameters.sql"
INSERT_PATH = "gs://{bucket_name}/013/queries/02_insert.sql"



class Process013(Process):
