...
QUERY_1 = "gs://{bucket_name}/002/queries/01_query_open_tickets.sql"
QUERY_2 = "gs://{bucket_name}/002/queries/02_query_avg_mttr_open_tickets.sql"


class Process002(Process):
    ...
    def _generate_query_1(self):
        self._execute_query(path=QUERY_1)

    def _generate_query_2(self):
        self._execute_query(path=QUERY_2)
