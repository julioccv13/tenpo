...
PARAMETERS_QUERY_PATH = "gs://{bucket_name}/003_Tenencia/01_Parametros.sql"
CALCULATE_QUERY_PATH = "gs://{bucket_name}/003_Tenencia/02_Query.sql"
INSERT_QUERY_PATH = "gs://{bucket_name}/003_Tenencia/03_Insert.sql"

class Process003_Tenencia(Process):
...
if __name__ == '__main__':
    args = get_args()
    process = Process003_Tenencia(**args)
